...
import os
if os.path.exists("vectorshop/notebooks/01_data_exploration.ipynb"):
    os.remove("vectorshop/notebooks/01_data_exploration.ipynb")
...
print("Updated notebook created successfully!") 